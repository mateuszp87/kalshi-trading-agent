...
def parse_args():
    ...
    parser.add_argument("--max-bet", type=float, default=5.0, help="Max bet size in dollars (default $5)")
    parser.add_argument("--max-positions", type=int, default=25, help="Max simultaneous open positions (default 25)")
